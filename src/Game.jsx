            ...
            {profileMenuOpen && (
              <div style={{
                ...
                <div
                  ...
                  style={{ padding: "12px 16px", fontSize: 13, color: th.text, cursor: "pointer", display: "flex", alignItems: "center", gap: 10, borderBottom: `1px solid ${th.borderLight}` }}
                >
                ...
                <div
                  ...
                  style={{ padding: "12px 16px", fontSize: 13, color: "#ef4444", cursor: "pointer", display: "flex", alignItems: "center", gap: 10, fontWeight: 600 }}
                >
                  <span style={{ fontSize: 16 }}>🚪</span>
                  <span>{t.logout}</span>
                </div>
