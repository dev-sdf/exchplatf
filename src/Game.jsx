          ...
          return (
            <div style={{ padding: "20px 16px", maxWidth: "600px", margin: "0 auto" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
                ...
                <button onClick={onLogout} style={{ marginLeft: "auto", background: th.bgCard, border: `1px solid ${th.borderColor}`, borderRadius: "8px", padding: "6px 12px", fontSize: "12px", color: th.textSecondary, cursor: "pointer", flexShrink: 0 }}>{t.logout}</button>
              </div>
              ...
              <h3 style={{ fontSize: "14px", fontWeight: 600, marginTop: "24px", marginBottom: "8px" }}>{t.activityLog}</h3>
