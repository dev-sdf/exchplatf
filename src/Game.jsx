                  ...
                  >
                    <div style={{ display: "flex", flexDirection: "column", gap: 3, minWidth: 0, flex: 1 }}>
                      ...
                      {myLikedItem ? (
                        ...
                        <div style={{ fontSize: 10, color: th.textMuted, lineHeight: 1.3 }}>{t.likeNotAssigned}</div>
                      )}
                    </div>
                    {myLikedItem && (
                      <div style={{ width: 110, height: 110, borderRadius: 8, overflow: "hidden", flexShrink: 0, background: th.bgInput, border: `2px solid ${likeAccent}`, boxShadow: `0 0 6px ${likeAccent}66` }}>
