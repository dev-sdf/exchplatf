          ...
          return (
            <div style={{ padding: "20px 16px", maxWidth: "600px", margin: "0 auto" }}>
              ...
              <div style={{ display: "flex", gap: "10px", marginBottom: "16px" }}>
                {/* IZQUIERDA: Billetera con escrow */}
                <div style={{
                  ...
                  {(me.likesEscrow || 0) > 0 && (me.likes || 0) >= 0 && (
                    <div style={{ fontSize: "10px", color: th.textMuted, lineHeight: 1.3 }}>
                      {t.likesAvailable}: <strong style={{ color: th.text }}>{availableLikes(me)} ❤️</strong>
                    </div>
                  )}
                </div>
                ...
                <div style={{
                  ...
                  {myLikedItem ? (
                    <div
                      onClick={() => openFeedView(t.likeStatus, "liked", `m:${myLikedItem.uid}`)}
