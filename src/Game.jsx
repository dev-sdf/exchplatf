...
export default function Game({ user, onLogout, lang, setLang, theme, setTheme }) {
  ...
  const renderMarketCard = (mObj) => {
    ...
    const cardLikeAccent = isLiked ? (walletLocked ? "#f59e0b" : "#38bdf8") : null;
    return (
      <div key={cardKey} style={{
        ...
        outline: isLiked ? `2px solid ${cardLikeAccent}` : "none",
        outlineOffset: "-1px",
        boxShadow: isLiked ? `0 0 12px ${cardLikeAccent}33` : "none",
      }}>
        {/* Owner bar */}
    ...
    <div style={{ minHeight: "100vh", background: th.bg, fontFamily: "'Segoe UI', system-ui, sans-serif", color: th.text, display: "flex", flexDirection: "column" }} onClick={closeAllDropdowns}>
      ...
      >
        <div style={{ maxWidth: "600px", margin: "0 auto", padding: "8px 14px" }}>
          ...
          {(() => {
            const likeAccent = walletLocked ? "#f59e0b" : "#38bdf8";
            const likeAccentBg = walletLocked ? "rgba(245,158,11,0.08)" : "rgba(56,189,248,0.06)";
            const likeAccentBorder = walletLocked ? "rgba(245,158,11,0.35)" : "rgba(56,189,248,0.3)";
            return (
              <div style={{
