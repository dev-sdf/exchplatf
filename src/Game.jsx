          ...
          <div ref={profileMenuRef} style={{ position: "relative" }} onClick={e => e.stopPropagation()}>
            ...
            {profileMenuOpen && (
              <div style={{
                ...
                {/* Tema + Idioma */}
                <div style={{ padding: "10px 16px", borderBottom: `1px solid ${th.borderLight}`, display: "flex", flexDirection: "column", gap: 10 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                    <span style={{ fontSize: 15 }}>{theme === "dark" ? "🌙" : "☀️"}</span>
                    <button
                      onClick={(e) => { e.stopPropagation(); toggleTheme(); }}
                      style={{ background: th.bgInput, border: `1px solid ${th.borderColor}`, borderRadius: "8px", padding: "4px 10px", fontSize: "13px", cursor: "pointer", color: th.text, lineHeight: 1 }}
                    >{theme === "dark" ? "☀️" : "🌙"}</button>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: th.textSecondary, flexShrink: 0 }}>
