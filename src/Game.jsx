              ...
              <div style={{
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: "9px", color: likeAccent, textTransform: "uppercase", letterSpacing: 0.3, fontWeight: 700, marginBottom: 5 }}>{t.likeStatus}</div>
                    {myLikedItem ? (
                      <div onClick={() => {
                        ...
                        <div style={{ width: 34, height: 34, borderRadius: 6, overflow: "hidden", flexShrink: 0, background: th.bgInput, border: `2px solid ${likeAccent}`, boxShadow: `0 0 6px ${likeAccent}66` }}>
                          <ItemImage src={getItemImages(myLikedItem)[0]} theme={theme} t={t} />
                        </div>
                        <div style={{ fontSize: 10, color: th.text, fontWeight: 600, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{myLikedItem.name}</div>
                      </div>
                    ) : (
