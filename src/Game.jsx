      ...
      >
        <div style={{ maxWidth: "600px", margin: "0 auto", padding: "8px 14px" }}>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            {/* Billetera */}
            <div style={{
              flex: 1, background: th.bgCard, borderRadius: "10px", padding: "10px 12px",
              border: `1px solid ${walletLocked ? "rgba(245,158,11,0.4)" : th.borderLight}`,
              ...
              {walletLocked && (
                <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                  <div style={{ fontSize: "9px", color: "#f59e0b", fontWeight: 700 }}>🔒 {t.walletLockedLabel}</div>
                  <button onClick={abortTransaction} style={{
                    background: "rgba(239,68,68,0.15)", border: "1px solid rgba(239,68,68,0.3)",
                    borderRadius: 5, padding: "4px 7px", fontSize: 9, fontWeight: 700,
                    cursor: "pointer", color: "#ef4444", alignSelf: "flex-start",
                  }}>{t.abortOffer}</button>
                </div>
              )}
            </div>
            ...
            <div style={{
              flex: 1, background: th.bgCard, borderRadius: "10px", padding: "10px 12px",
              border: `1px solid ${th.borderLight}`, display: "flex", flexDirection: "column", minWidth: 0,
            }}>
              <div style={{ fontSize: "9px", color: th.textSecondary, textTransform: "uppercase", letterSpacing: 0.3, fontWeight: 700, marginBottom: 6 }}>{t.likeStatus}</div>
              {myLikedItem ? (
                <div onClick={() => {
                  ...
                  <div style={{ width: 36, height: 36, borderRadius: 7, overflow: "hidden", flexShrink: 0, background: th.bgInput }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", flex: 1, gap: 5 }}>
                  ...
                  <button onClick={() => setTab("market")} style={{
                    ...
                    padding: "4px 7px", fontSize: 9, fontWeight: 700, cursor: "pointer", alignSelf: "flex-start",
                  }}>{t.goToMarket}</button>
                </div>
              )}
            </div>
